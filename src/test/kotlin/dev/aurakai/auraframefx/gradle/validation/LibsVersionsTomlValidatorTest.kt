...
class LibsVersionsTomlValidatorTest {
    ...
    @Test
    fun `validate should handle TOML with raw string literals`() {
        val rawStringToml = """
            [versions]
            raw-version = 1.0.0
            multiline-raw = """
    ...
    fun `validate should handle TOML with nested array structures`() {
        ...
        # Nested arrays in bundles should be invalid
        assertFalse(result.isValid)
    ...
    fun `validate should handle extremely short version strings`() {
        ...
        # Should validate appropriately for non-standard but potentially valid versions
