...
class ThemeManager @Inject constructor(
    ...
    /**
     * Applies a system theme by interpreting a user's natural language query using AI.
     *
     * Uses AI intent recognition to determine the desired theme from the query, maps it to a predefined theme, and attempts to apply it system-wide. Returns a [ThemeResult] indicating success, inability to understand the query, or an error.
     *
     ...
     *
     * Uses AI analysis to interpret the context and recommend suitable themes. Returns an empty list if no relevant suggestions are found or if an error occurs.
     *
