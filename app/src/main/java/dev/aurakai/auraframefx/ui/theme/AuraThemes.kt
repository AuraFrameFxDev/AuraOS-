...
/**
 * Returns the Material3 color scheme for this theme, choosing light or dark mode based on the provided flag.
 *
 * @param isDarkTheme If true, returns the dark color scheme; otherwise, returns the light color scheme.
 * @return The appropriate color scheme for the specified theme mode.
 */
@Composable
