...
/**
 * Returns the appropriate Material3 color scheme for this theme based on the specified dark mode flag.
 *
 * @param isDarkTheme If true, returns the dark color scheme; otherwise, returns the light color scheme.
 * @return The color scheme corresponding to the selected theme mode.
 */
@Composable
